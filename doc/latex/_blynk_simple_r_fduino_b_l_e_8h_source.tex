\hypertarget{_blynk_simple_r_fduino_b_l_e_8h_source}{}\doxysection{Blynk\+Simple\+RFduino\+BLE.\+h}
\label{_blynk_simple_r_fduino_b_l_e_8h_source}\index{lib/Blynk/src/BlynkSimpleRFduinoBLE.h@{lib/Blynk/src/BlynkSimpleRFduinoBLE.h}}
\mbox{\hyperlink{_blynk_simple_r_fduino_b_l_e_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
\DoxyCodeLine{1 }
\DoxyCodeLine{11 \textcolor{preprocessor}{\#ifndef BlynkSimpleRFduinoBLE\_h}}
\DoxyCodeLine{12 \textcolor{preprocessor}{\#define BlynkSimpleRFduinoBLE\_h}}
\DoxyCodeLine{13 }
\DoxyCodeLine{14 \textcolor{preprocessor}{\#ifndef BLYNK\_INFO\_CONNECTION}}
\DoxyCodeLine{15 \textcolor{preprocessor}{\#define BLYNK\_INFO\_CONNECTION "{}RFduinoBLE"{}}}
...
\DoxyCodeLine{25 \textcolor{preprocessor}{\#include <RFduinoBLE.h>}}
\DoxyCodeLine{26 }
\DoxyCodeLine{27 \textcolor{keyword}{class }\mbox{\hyperlink{class_blynk_transport_r_fduino_b_l_e}{BlynkTransportRFduinoBLE}}}
\DoxyCodeLine{28 \{}
\DoxyCodeLine{29 \textcolor{keyword}{public}:}
\DoxyCodeLine{30     \mbox{\hyperlink{class_blynk_transport_r_fduino_b_l_e}{BlynkTransportRFduinoBLE}}()}
...
\DoxyCodeLine{70         RFduinoBLE.send((\textcolor{keyword}{const} \textcolor{keywordtype}{char}*)buf, len);}
...
\DoxyCodeLine{93     \textcolor{keyword}{static} \mbox{\hyperlink{class_blynk_transport_r_fduino_b_l_e}{BlynkTransportRFduinoBLE}}* instance;}
\DoxyCodeLine{94 }
...
\DoxyCodeLine{99 \};}
\DoxyCodeLine{100 }
\DoxyCodeLine{101 \textcolor{keyword}{class }\mbox{\hyperlink{class_blynk_simple_r_fduino_b_l_e}{BlynkSimpleRFduinoBLE}}}
\DoxyCodeLine{102     : \textcolor{keyword}{public} \mbox{\hyperlink{class_blynk_protocol}{BlynkProtocol}}<BlynkTransportRFduinoBLE>}
\DoxyCodeLine{103 \{}
\DoxyCodeLine{104     \textcolor{keyword}{typedef} \mbox{\hyperlink{class_blynk_protocol}{BlynkProtocol<BlynkTransportRFduinoBLE>}} \mbox{\hyperlink{class_blynk_protocol}{Base}};}
\DoxyCodeLine{105 \textcolor{keyword}{public}:}
\DoxyCodeLine{106     \mbox{\hyperlink{class_blynk_simple_r_fduino_b_l_e}{BlynkSimpleRFduinoBLE}}(\mbox{\hyperlink{class_blynk_transport_r_fduino_b_l_e}{BlynkTransportRFduinoBLE}}\& transp)}
...
\DoxyCodeLine{116 \};}
\DoxyCodeLine{117 }
\DoxyCodeLine{118 \mbox{\hyperlink{class_blynk_transport_r_fduino_b_l_e}{BlynkTransportRFduinoBLE}}* BlynkTransportRFduinoBLE::instance = NULL;}
\DoxyCodeLine{119 }
\DoxyCodeLine{120 \textcolor{keyword}{static} \mbox{\hyperlink{class_blynk_transport_r_fduino_b_l_e}{BlynkTransportRFduinoBLE}} \_blynkTransport;}
\DoxyCodeLine{121 \mbox{\hyperlink{class_blynk_simple_r_fduino_b_l_e}{BlynkSimpleRFduinoBLE}} Blynk(\_blynkTransport);}
\DoxyCodeLine{122 }
\DoxyCodeLine{123 }
\DoxyCodeLine{124 \textcolor{keywordtype}{void} RFduinoBLE\_onConnect()}
\DoxyCodeLine{125 \{}
\DoxyCodeLine{126   BLYNK\_LOG1(\textcolor{stringliteral}{"{}Device connected"{}});}
\DoxyCodeLine{127   Blynk.startSession();}
\DoxyCodeLine{128 \}}
\DoxyCodeLine{129 }
\DoxyCodeLine{130 \textcolor{keywordtype}{void} RFduinoBLE\_onDisconnect()}
\DoxyCodeLine{131 \{}
\DoxyCodeLine{132   BLYNK\_LOG1(\textcolor{stringliteral}{"{}Device disconnected"{}});}
\DoxyCodeLine{133   Blynk.disconnect();}
\DoxyCodeLine{134 \}}
\DoxyCodeLine{135 }
\DoxyCodeLine{136 \textcolor{keywordtype}{void} RFduinoBLE\_onReceive(\textcolor{keywordtype}{char}* data, \textcolor{keywordtype}{int} len)}
\DoxyCodeLine{137 \{}
