\hypertarget{_edgent___m_k_r1010_2_blynk_edgent_8h_source}{}\doxysection{Blynk\+Edgent.\+h}
\label{_edgent___m_k_r1010_2_blynk_edgent_8h_source}\index{lib/Blynk/examples/Blynk.Edgent/Edgent\_MKR1010/BlynkEdgent.h@{lib/Blynk/examples/Blynk.Edgent/Edgent\_MKR1010/BlynkEdgent.h}}
...
\DoxyCodeLine{9 \textcolor{preprocessor}{\#include <WiFiNINA.h>}}
\DoxyCodeLine{10 }
...
\DoxyCodeLine{83   \{}
\DoxyCodeLine{84     indicator\_init();}
\DoxyCodeLine{85     button\_init();}
\DoxyCodeLine{86     config\_init();}
\DoxyCodeLine{87     console\_init();}
\DoxyCodeLine{88 }
\DoxyCodeLine{89     printDeviceBanner();}
\DoxyCodeLine{90 }
\DoxyCodeLine{91     \textcolor{keywordflow}{if} (configStore.getFlag(CONFIG\_FLAG\_VALID)) \{}
\DoxyCodeLine{92       BlynkState::set(MODE\_CONNECTING\_NET);}
\DoxyCodeLine{93     \} \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (config\_load\_blnkopt()) \{}
\DoxyCodeLine{94       \mbox{\hyperlink{_d_h_t_8h_a88edd2aa4feabff4af21a997d5d8aa23}{DEBUG\_PRINT}}(\textcolor{stringliteral}{"{}Firmware is preprovisioned"{}});}
\DoxyCodeLine{95       BlynkState::set(MODE\_CONNECTING\_NET);}
\DoxyCodeLine{96     \} \textcolor{keywordflow}{else} \{}
\DoxyCodeLine{97       BlynkState::set(MODE\_WAIT\_CONFIG);}
\DoxyCodeLine{98     \}}
\DoxyCodeLine{99   \}}
\DoxyCodeLine{100 }
\DoxyCodeLine{101   \textcolor{keywordtype}{void} run() \{}
\DoxyCodeLine{102     app\_loop();}
\DoxyCodeLine{103     \textcolor{keywordflow}{switch} (BlynkState::get()) \{}
\DoxyCodeLine{104     \textcolor{keywordflow}{case} MODE\_WAIT\_CONFIG:       }
\DoxyCodeLine{105     \textcolor{keywordflow}{case} MODE\_CONFIGURING:       enterConfigMode();    \textcolor{keywordflow}{break};}
\DoxyCodeLine{106     \textcolor{keywordflow}{case} MODE\_CONNECTING\_NET:    enterConnectNet();    \textcolor{keywordflow}{break};}
\DoxyCodeLine{107     \textcolor{keywordflow}{case} MODE\_CONNECTING\_CLOUD:  enterConnectCloud();  \textcolor{keywordflow}{break};}
\DoxyCodeLine{108     \textcolor{keywordflow}{case} MODE\_RUNNING:           runBlynkWithChecks(); \textcolor{keywordflow}{break};}
\DoxyCodeLine{109     \textcolor{keywordflow}{case} MODE\_OTA\_UPGRADE:       enterOTA();           \textcolor{keywordflow}{break};}
\DoxyCodeLine{110     \textcolor{keywordflow}{case} MODE\_SWITCH\_TO\_STA:     enterSwitchToSTA();   \textcolor{keywordflow}{break};}
\DoxyCodeLine{111     \textcolor{keywordflow}{case} MODE\_RESET\_CONFIG:      enterResetConfig();   \textcolor{keywordflow}{break};}
\DoxyCodeLine{112     \textcolor{keywordflow}{default}:                     enterError();         \textcolor{keywordflow}{break};}
\DoxyCodeLine{113     \}}
\DoxyCodeLine{114   \}}
\DoxyCodeLine{115 }
\DoxyCodeLine{116 \};}
\DoxyCodeLine{117 }
\DoxyCodeLine{118 \mbox{\hyperlink{class_edgent}{Edgent}} BlynkEdgent;}
\DoxyCodeLine{119 BlynkTimer edgentTimer;}
\DoxyCodeLine{120 }
\DoxyCodeLine{121 \textcolor{keywordtype}{void} app\_loop() \{}
\DoxyCodeLine{122     edgentTimer.run();}
\DoxyCodeLine{123     edgentConsole.run();}
\DoxyCodeLine{124 \}}
\DoxyCodeLine{125 }
