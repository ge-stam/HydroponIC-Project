\hypertarget{_blynk_api_arduino_8h_source}{}\doxysection{Blynk\+Api\+Arduino.\+h}
\label{_blynk_api_arduino_8h_source}\index{lib/Blynk/src/BlynkApiArduino.h@{lib/Blynk/src/BlynkApiArduino.h}}
\mbox{\hyperlink{_blynk_api_arduino_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
\DoxyCodeLine{1 }
\DoxyCodeLine{11 \textcolor{preprocessor}{\#ifndef BlynkApiArduino\_h}}
\DoxyCodeLine{12 \textcolor{preprocessor}{\#define BlynkApiArduino\_h}}
\DoxyCodeLine{13 }
...
\DoxyCodeLine{152 }
\DoxyCodeLine{153 \textcolor{comment}{// TODO: Remove workaround for ESP32}}
\DoxyCodeLine{154 \textcolor{preprocessor}{\#if !defined(ESP32)}}
\DoxyCodeLine{155 }
\DoxyCodeLine{156     \textcolor{keywordflow}{case} BLYNK\_HW\_AW: \{}
\DoxyCodeLine{157         \textcolor{comment}{// Should be 1 parameter (value)}}
\DoxyCodeLine{158         \textcolor{keywordflow}{if} (++it >= param.end())}
\DoxyCodeLine{159             \textcolor{keywordflow}{return};}
\DoxyCodeLine{160 }
\DoxyCodeLine{161 \textcolor{preprocessor}{\#ifndef BLYNK\_MINIMIZE\_PINMODE\_USAGE}}
\DoxyCodeLine{162         pinMode(pin, OUTPUT);}
\DoxyCodeLine{163 \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{164         analogWrite(pin, it.asInt());}
\DoxyCodeLine{165     \} \textcolor{keywordflow}{break};}
\DoxyCodeLine{166 }
\DoxyCodeLine{167 \textcolor{preprocessor}{\#endif }\textcolor{comment}{// TODO: Remove workaround for ESP32}}
\DoxyCodeLine{168 }
\DoxyCodeLine{169 \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{170 }
\DoxyCodeLine{171     \textcolor{keywordflow}{case} BLYNK\_HW\_VR: \{}
\DoxyCodeLine{172         callReadHandler(pin);}
\DoxyCodeLine{173     \} \textcolor{keywordflow}{break};}
\DoxyCodeLine{174     \textcolor{keywordflow}{case} BLYNK\_HW\_VW: \{}
\DoxyCodeLine{175         ++it;}
\DoxyCodeLine{176         \textcolor{keywordtype}{char}* start = (\textcolor{keywordtype}{char}*)it.asStr();}
\DoxyCodeLine{177         \mbox{\hyperlink{class_blynk_param}{BlynkParam}} param2(start, len -\/ (start -\/ (\textcolor{keywordtype}{char}*)buff));}
\DoxyCodeLine{178         callWriteHandler(pin, param2);}
\DoxyCodeLine{179     \} \textcolor{keywordflow}{break};}
\DoxyCodeLine{180     \textcolor{keywordflow}{default}:}
\DoxyCodeLine{181         BLYNK\_LOG2(BLYNK\_F(\textcolor{stringliteral}{"{}Invalid HW cmd: "{}}), cmd);}
\DoxyCodeLine{182         \textcolor{keyword}{static\_cast<}Proto*\textcolor{keyword}{>}(\textcolor{keyword}{this})-\/>sendCmd(BLYNK\_CMD\_RESPONSE, \textcolor{keyword}{static\_cast<}Proto*\textcolor{keyword}{>}(\textcolor{keyword}{this})-\/>msgIdOutOverride, NULL, BLYNK\_ILLEGAL\_COMMAND);}
\DoxyCodeLine{183     \}}
\DoxyCodeLine{184 \}}
\DoxyCodeLine{185 }
