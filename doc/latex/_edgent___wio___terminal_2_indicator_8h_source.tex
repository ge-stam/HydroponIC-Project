\hypertarget{_edgent___wio___terminal_2_indicator_8h_source}{}\doxysection{Indicator.\+h}
\label{_edgent___wio___terminal_2_indicator_8h_source}\index{lib/Blynk/examples/Blynk.Edgent/Edgent\_Wio\_Terminal/Indicator.h@{lib/Blynk/examples/Blynk.Edgent/Edgent\_Wio\_Terminal/Indicator.h}}
...
\DoxyCodeLine{206 }
\DoxyCodeLine{207 \textcolor{preprocessor}{\#if defined(USE\_TC3)}}
\DoxyCodeLine{208 }
\DoxyCodeLine{209 \textcolor{preprocessor}{  \#include <TimerTC3.h>}}
\DoxyCodeLine{210 }
\DoxyCodeLine{211   \textcolor{keywordtype}{void} indicator\_run() \{}
\DoxyCodeLine{212     uint32\_t returnTime = indicator.run();}
\DoxyCodeLine{213     \textcolor{keywordflow}{if} (returnTime) \{}
\DoxyCodeLine{214       TimerTc3.initialize(returnTime*1000);}
\DoxyCodeLine{215     \}}
\DoxyCodeLine{216   \}}
\DoxyCodeLine{217 }
\DoxyCodeLine{218   \textcolor{keywordtype}{void} indicator\_init() \{}
\DoxyCodeLine{219     indicator.init();}
\DoxyCodeLine{220     TimerTc3.initialize(100*1000);}
\DoxyCodeLine{221     TimerTc3.attachInterrupt(indicator\_run);}
\DoxyCodeLine{222   \}}
\DoxyCodeLine{223 }
\DoxyCodeLine{224 \textcolor{preprocessor}{\#elif defined(USE\_TCC0)}}
\DoxyCodeLine{225 }
\DoxyCodeLine{226 \textcolor{preprocessor}{  \#include <TimerThree.h>}}
\DoxyCodeLine{227 }
\DoxyCodeLine{228   \textcolor{keywordtype}{void} indicator\_run() \{}
\DoxyCodeLine{229     uint32\_t returnTime = indicator.run();}
\DoxyCodeLine{230     \textcolor{keywordflow}{if} (returnTime) \{}
\DoxyCodeLine{231       Timer3.initialize(returnTime*1000);}
\DoxyCodeLine{232     \}}
\DoxyCodeLine{233   \}}
\DoxyCodeLine{234 }
\DoxyCodeLine{235   \textcolor{keywordtype}{void} indicator\_init() \{}
\DoxyCodeLine{236     indicator.init();}
\DoxyCodeLine{237     Timer3.initialize(100*1000);}
\DoxyCodeLine{238     Timer3.attachInterrupt(indicator\_run);}
\DoxyCodeLine{239   \}}
\DoxyCodeLine{240 }
\DoxyCodeLine{241 \textcolor{preprocessor}{\#else}}
\DoxyCodeLine{242 }
\DoxyCodeLine{243 \textcolor{preprocessor}{  \#warning LED indicator needs a functional timer!}}
\DoxyCodeLine{244 }
\DoxyCodeLine{245   \textcolor{keywordtype}{void} indicator\_run() \{\}}
\DoxyCodeLine{246   \textcolor{keywordtype}{void} indicator\_init() \{\}}
\DoxyCodeLine{247 }
