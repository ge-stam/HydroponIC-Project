\hypertarget{_edgent___e_s_p32_2_config_store_8h_source}{}\doxysection{Config\+Store.\+h}
\label{_edgent___e_s_p32_2_config_store_8h_source}\index{lib/Blynk/examples/Blynk.Edgent/Edgent\_ESP32/ConfigStore.h@{lib/Blynk/examples/Blynk.Edgent/Edgent\_ESP32/ConfigStore.h}}
...
\DoxyCodeLine{99 \}}
\DoxyCodeLine{100 }
\DoxyCodeLine{101 \textcolor{preprocessor}{\#include <Preferences.h>}}
\DoxyCodeLine{102 Preferences preferences;}
\DoxyCodeLine{103 }
\DoxyCodeLine{104 \textcolor{keywordtype}{void} config\_load()}
\DoxyCodeLine{105 \{}
\DoxyCodeLine{106   memset(\&configStore, 0, \textcolor{keyword}{sizeof}(configStore));}
\DoxyCodeLine{107   preferences.getBytes(\textcolor{stringliteral}{"{}config"{}}, \&configStore, \textcolor{keyword}{sizeof}(configStore));}
\DoxyCodeLine{108   \textcolor{keywordflow}{if} (configStore.magic != configDefault.magic) \{}
\DoxyCodeLine{109     \mbox{\hyperlink{_d_h_t_8h_a88edd2aa4feabff4af21a997d5d8aa23}{DEBUG\_PRINT}}(\textcolor{stringliteral}{"{}Using default config."{}});}
\DoxyCodeLine{110     configStore = configDefault;}
\DoxyCodeLine{111     \textcolor{keywordflow}{return};}
\DoxyCodeLine{112   \}}
\DoxyCodeLine{113 \}}
\DoxyCodeLine{114 }
\DoxyCodeLine{115 \textcolor{keywordtype}{bool} config\_save()}
\DoxyCodeLine{116 \{}
\DoxyCodeLine{117   preferences.putBytes(\textcolor{stringliteral}{"{}config"{}}, \&configStore, \textcolor{keyword}{sizeof}(configStore));}
\DoxyCodeLine{118   \mbox{\hyperlink{_d_h_t_8h_a88edd2aa4feabff4af21a997d5d8aa23}{DEBUG\_PRINT}}(\textcolor{stringliteral}{"{}Configuration stored to flash"{}});}
\DoxyCodeLine{119   \textcolor{keywordflow}{return} \textcolor{keyword}{true};}
\DoxyCodeLine{120 \}}
\DoxyCodeLine{121 }
\DoxyCodeLine{122 \textcolor{keywordtype}{bool} config\_init()}
\DoxyCodeLine{123 \{}
\DoxyCodeLine{124   preferences.begin(\textcolor{stringliteral}{"{}blynk"{}}, \textcolor{keyword}{false});}
\DoxyCodeLine{125   config\_load();}
\DoxyCodeLine{126   \textcolor{keywordflow}{return} \textcolor{keyword}{true};}
\DoxyCodeLine{127 \}}
\DoxyCodeLine{128 }
\DoxyCodeLine{129 \textcolor{keywordtype}{void} enterResetConfig()}
\DoxyCodeLine{130 \{}
\DoxyCodeLine{131   \mbox{\hyperlink{_d_h_t_8h_a88edd2aa4feabff4af21a997d5d8aa23}{DEBUG\_PRINT}}(\textcolor{stringliteral}{"{}Resetting configuration!"{}});}
\DoxyCodeLine{132   configStore = configDefault;}
\DoxyCodeLine{133   config\_save();}
\DoxyCodeLine{134   eraseMcuConfig();}
\DoxyCodeLine{135   BlynkState::set(MODE\_WAIT\_CONFIG);}
\DoxyCodeLine{136 \}}
\DoxyCodeLine{137 }
\DoxyCodeLine{138 \textcolor{keywordtype}{void} config\_set\_last\_error(\textcolor{keywordtype}{int} error) \{}
\DoxyCodeLine{139   \textcolor{comment}{// Only set error if not provisioned}}
\DoxyCodeLine{140   \textcolor{keywordflow}{if} (!configStore.getFlag(CONFIG\_FLAG\_VALID)) \{}
\DoxyCodeLine{141     configStore = configDefault;}
\DoxyCodeLine{142     configStore.last\_error = error;}
\DoxyCodeLine{143     BLYNK\_LOG2(\textcolor{stringliteral}{"{}Last error code: "{}}, error);}
\DoxyCodeLine{144     config\_save();}
\DoxyCodeLine{145   \}}
\DoxyCodeLine{146 \}}
\DoxyCodeLine{147 }
